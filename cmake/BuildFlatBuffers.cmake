...
function(flatbuffers_generate_headers)
  ...
  add_library(${FLATBUFFERS_GENERATE_HEADERS_TARGET} OBJECT)
  target_sources(
  ...
  add_dependencies(
    ${FLATBUFFERS_GENERATE_HEADERS_TARGET}
    ${FLATC})
  target_link_libraries(${FLATBUFFERS_GENERATE_HEADERS_TARGET} PUBLIC flatbuffers::flatbuffers)
  target_include_directories(
    ${FLATBUFFERS_GENERATE_HEADERS_TARGET}
    PUBLIC ${generated_target_dir})
